...
describe Digitalitem do
  ...
  before(:context) do
    ...
    @digitalitem2 = Digitalitem.new("Generic Item",1.99, 10)
  end
  ...
  describe "Initialization" do
    ...
    it "should set Download size if passed in" do
      expect(@digitalitem2.download_size).to eq(10)
    end
    it "should have a download size of 0 if not specified" do
      expect(@digitalitem.download_size).to eql(0)
    end
  end
